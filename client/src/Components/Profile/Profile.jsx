              ...
              <div className="container-fluid">
                ...
                <div className="row">
                  ...
                  <div className="col-4 p-2">
                    ...
                    <input key={Date.now()} defaultValue={ProfileData.email} readOnly={true} ref={(input) => emailRef = input} className="form-control animated fadeInUp" type="email" />
                  </div>
                  <div className="col-4 p-2">
                  ...
                  <div className="col-4 p-2">
                    <label>Mobile</label>
                    <input key={Date.now()} defaultValue={ProfileData.mobile} ref={(input) => mobileRef = input} className="form-control animated fadeInUp" type="text" />
                  </div>
                  <div className="col-4 p-2">
